package org.arcticquests.dev.oneironaut.Oneironaut.casting.patterns
...
class OpCompareSignature : ConstMediaAction {
    ...
    override fun execute(args: List<Iota>, env: CastingEnvironment): List<Iota> {
        ...
        val readItemInfo : CastingEnvironment.HeldItemInfo = env.getHeldItemToOperateOn {it.item != Items.AIR} ?: throw MishapBadOffhandItem(null, Compon.of("no_item.offhand"))
