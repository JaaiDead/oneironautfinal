...
import org.arcticquests.dev.oneironaut.Oneironaut.item.ReverberationRod;
...
public class OneironautClient {
    ...
    private static void doClientRegistration() {
        ...
        ItemProperties.register(OneironautItemRegistry.SHIFTING_PSEUDOAMETHYST.get(), new ResourceLocation(Oneironaut.MOD_ID, "observation"),
                OneironautClient::processObservationPredicate);
        ItemProperties.register(OneironautItemRegistry.LIBRARY_CARD.get(), new ResourceLocation(Oneironaut.MOD_ID, "written"), (stack, world, holder, holderID) -> {
