...
public class MediaGelBlock extends HalfTransparentBlock {
    ...
    private static FrozenPigment makePurpleColorizer() {
        return new FrozenPigment(
                HexItems.DYE_PIGMENTS.get(DyeColor.PURPLE).getDefaultInstance(),
                new UUID(0, 0)
        );
    }
    ...
    public void stepOn(Level world, BlockPos pos, BlockState state, Entity entity) {
        if (!entity.isSteppingCarefully()
            ...
            FrozenPigment purpleColorizer = makePurpleColorizer();
